...
function getBlockStyle(block) {
  switch (block.getType()) {
    ...
    case 'justify-align':   return 'RichEditor-justify-align';
    default: return null;
  }
}
...
class App extends Component {
  ...
  changeLanguage(e){
    var idlanguage = document.getElementById("language");
    var option = idlanguage.options[idlanguage.selectedIndex].value;
    this.setState({
      options:{
        mode: option,
      },
  ...
  render(){
    ...
    return(
      <div>
        <form>
          <select id="language" onChange={this.changeLanguage}>
            <option value="javascript">javascript</option>
            <option value="markdown">html</option>
          </select>
        </form>
        <CodeMirror value="//Code" onChange={this.updateCode} options={this.state.options} />
        <RichEditorExample />
      </div>
    );
